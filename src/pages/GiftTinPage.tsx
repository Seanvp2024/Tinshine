...
import { giftTinProducts } from '@/lib/productData';

export default function GiftTinPage() {
  ...
  const currentProducts = giftTinProducts.slice(indexOfFirstProduct, indexOfLastProduct);
  
  // 计算总页数
  const totalPages = Math.ceil(giftTinProducts.length / productsPerPage);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      {/* Hero Section */}
      <section className="relative h-72 bg-gradient-to-r from-purple-600 to-purple-800 overflow-hidden">
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Gift Tin</h1>
            <p className="text-xl text-white/90 max-w-2xl">
              Elegant and decorative gift tins perfect for special occasions and premium presentations.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <SectionHeader 
            title="Gift Tins Collection" 
            subtitle="Beautiful packaging solutions to make your gifts even more special" 
            align="left"
          />
