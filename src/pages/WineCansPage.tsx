...
import { wineCansProducts } from '@/lib/productData';

export default function WineCansPage() {
  ...
  const currentProducts = wineCansProducts.slice(indexOfFirstProduct, indexOfLastProduct);
  
  // 计算总页数
  const totalPages = Math.ceil(wineCansProducts.length / productsPerPage);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      {/* Hero Section */}
      <section className="relative h-72 bg-gradient-to-r from-red-600 to-red-800 overflow-hidden">
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Wine Cans</h1>
            <p className="text-xl text-white/90 max-w-2xl">
              Stylish and durable wine cans designed to keep your favorite beverages fresh and portable.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <SectionHeader 
            title="Wine Cans Collection" 
            subtitle="Discover our premium wine cans for the perfect drinking experience" 
            align="left"
          />
