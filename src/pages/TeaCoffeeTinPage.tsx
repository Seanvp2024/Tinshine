...
import { teaCoffeeTinProducts } from '@/lib/productData';

export default function TeaCoffeeTinPage() {
  ...
  const currentProducts = teaCoffeeTinProducts.slice(indexOfFirstProduct, indexOfLastProduct);
  
  // 计算总页数
  const totalPages = Math.ceil(teaCoffeeTinProducts.length / productsPerPage);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      {/* Hero Section */}
      <section className="relative h-72 bg-gradient-to-r from-amber-600 to-amber-800 overflow-hidden">
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Tea Coffee Tin</h1>
            <p className="text-xl text-white/90 max-w-2xl">
              Premium tins designed to keep your tea and coffee fresh, flavorful, and aromatic.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <SectionHeader 
            title="Tea & Coffee Tins" 
            subtitle="Specialized packaging to preserve the freshness of your favorite beverages" 
            align="left"
          />
