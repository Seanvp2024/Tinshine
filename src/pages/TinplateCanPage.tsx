...
import { tinplateCanProducts } from '@/lib/productData';

export default function TinplateCanPage() {
  ...
  const currentProducts = tinplateCanProducts.slice(indexOfFirstProduct, indexOfLastProduct);
  
  // 计算总页数
  const totalPages = Math.ceil(tinplateCanProducts.length / productsPerPage);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      {/* Hero Section */}
      <section className="relative h-72 bg-gradient-to-r from-slate-600 to-slate-800 overflow-hidden">
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Tinplate Can</h1>
            <p className="text-xl text-white/90 max-w-2xl">
              High-quality tinplate cans for industrial and commercial packaging solutions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <SectionHeader 
            title="Tinplate Cans Collection" 
            subtitle="Robust packaging solutions for various industrial applications" 
            align="left"
          />
