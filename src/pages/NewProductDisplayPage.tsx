...
import { newProductDisplayProducts } from '@/lib/productData';

export default function NewProductDisplayPage() {
  ...
  const currentProducts = newProductDisplayProducts.slice(indexOfFirstProduct, indexOfLastProduct);
  
  // 计算总页数
  const totalPages = Math.ceil(newProductDisplayProducts.length / productsPerPage);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      {/* Hero Section */}
      <section className="relative h-72 bg-gradient-to-r from-indigo-600 to-indigo-800 overflow-hidden">
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">New Product Display</h1>
            <p className="text-xl text-white/90 max-w-2xl">
              Discover our latest innovations and new arrivals in tin packaging solutions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <SectionHeader 
            title="New Arrivals" 
            subtitle="Be the first to explore our newest products and innovations" 
            align="left"
          />
